...
const ProjectCard: React.FC<{ project: SavedProject; onView: () => void; }> = ({ project, onView }) => (
  <Card className="flex flex-col h-full">
    <h3 className="text-md font-semibold text-brand-primary-hover mb-2">{project.projectName}</h3>
    <p className="text-sm text-brand-text-secondary flex-grow mb-4 line-clamp-2">{project.shortDescription}</p>
        ...
        <div className="flex flex-col gap-6">
             <Card className="flex items-center gap-4 hover:border-brand-primary/50 transition-colors">
                 ...
                 <div>
                    ...
                    <button onClick={() => onScreenChange('templates')} className="text-sm text-brand-primary hover:underline">
                        Kickstart your work
                    </button>
                 </div>
             </Card>
             <Card className="flex items-center gap-4 hover:border-brand-primary/50 transition-colors">
                 ...
                 <div>
                    ...
                    <button onClick={() => onScreenChange('projects')} className="text-sm text-brand-primary hover:underline">
                        View all your plans
                    </button>
                 </div>
             </Card>
