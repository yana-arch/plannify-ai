...
export const projectTemplates: TemplateData[] = [
  {
    ...
    shortDescription:
      'A modern, responsive web application with user authentication and a dynamic frontend.',
    ...
    coreRequirements: [
      {
        id: '1',
        description: 'User registration and login (email/password, OAuth)',
        priority: 'High',
      },
    ...
    marketAnalysis:
      'The market for general web applications is vast. Success depends on finding a niche and providing a superior user experience compared to existing solutions.',
    ...
    riskAssessment: [
      {
        ...
        probability: 'Low',
        mitigation:
          'Implement strong encryption, regular security audits, and follow data privacy best practices.',
      },
      {
        ...
        probability: 'Medium',
        mitigation:
          'Design a scalable architecture from the start, use load balancing, and monitor performance.',
      },
    ],
    featureDependencies: {
      '1': [],
  ...
  },
  {
    ...
    shortDescription:
      'A robust backend service to support a mobile application, with a focus on API performance and security.',
    businessGoals:
      'Provide reliable data and services for the mobile app, ensuring a smooth user experience.',
    ...
    marketAnalysis:
      'The success of a mobile backend is directly tied to the success of the mobile app it serves. The market requires high reliability and scalability to handle fluctuating user loads.',
    ...
    riskAssessment: [
      {
        ...
        probability: 'Medium',
        mitigation:
          'Implement robust authentication, input validation, and regular security testing (pentesting).',
      },
      {
        ...
        probability: 'High',
        mitigation:
          'Design a clear API contract, use versioning, and implement offline-first strategies on the client.',
      },
    ],
    featureDependencies: {
      '1': [],
  ...
  },
  {
    ...
    shortDescription:
      'An internal dashboard for visualizing and analyzing business intelligence data from multiple sources.',
    businessGoals:
      'Empower business teams to make data-driven decisions by providing real-time insights.',
    ...
    coreModules: [
      {
        ...
        description:
          'Connect and ingest data from various sources including databases, APIs, and external services.',
        flows: [
      ...
      },
      {
        ...
        description:
          'Create and manage interactive charts, graphs, and dashboards with custom configurations.',
        flows: [
    ...
    coreRequirements: [
      {
        id: '1',
        description: 'Integration with multiple data sources (SQL, NoSQL, APIs)',
        priority: 'High',
      },
    ...
    riskAssessment: [
      {
        ...
        probability: 'Medium',
        mitigation:
          'Implement robust data validation, monitoring, and cleansing processes with automated quality checks.',
      },
      {
        ...
        probability: 'High',
        mitigation:
          'Use efficient data structures, implement caching layers, and optimize queries with proper indexing.',
      },
      {
        ...
        probability: 'Low',
        mitigation:
          'Encrypt sensitive data, implement role-based access control, and conduct regular security audits.',
      },
    ],
    featureDependencies: {
    ...
    marketAnalysis:
      'Internal tools market is focused on increasing efficiency. Key selling points are ease of use, powerful features, and seamless integration with existing company data stacks.',
  ...
  },
  {
    ...
    shortDescription:
      'A feature-rich e-commerce platform with a product catalog, shopping cart, and secure checkout process.',
    businessGoals:
      'Drive online sales, increase customer retention, and provide a seamless shopping experience.',
    technicalGoals:
      'Ensure high availability during peak traffic, secure payment processing, and fast page load times (Core Web Vitals).',
    ...
    coreModules: [
      {
        ...
        description:
          'Manage product information, categories, inventory, and pricing with rich media support.',
        flows: [
      ...
      },
      {
        ...
        description:
          'Handle product browsing, search, cart management, and checkout process for customers.',
        flows: [
      ...
      },
      {
        ...
        description:
          'Process and fulfill orders, handle returns, and manage customer communications.',
        flows: [
      ...
      },
      {
        ...
        description:
          'Track sales performance, customer behavior, and business metrics with insights.',
        flows: [
    ...
    coreRequirements: [
      {
        id: '1',
        description: 'Product catalog with categories, filtering, and search',
        priority: 'High',
      },
      { id: '2', description: 'Shopping cart and multi-step checkout flow', priority: 'High' },
      {
        id: '3',
        description: 'Integration with a payment gateway (e.g., Stripe, PayPal)',
        priority: 'High',
      },
    ...
    riskAssessment: [
      {
        ...
        probability: 'Medium',
        mitigation:
          'Implement multiple payment gateways, proper error handling, and transaction monitoring with automatic failover.',
      },
      {
        ...
        probability: 'High',
        mitigation:
          'Use atomic inventory updates, implement real-time stock tracking, and add inventory alerts for low stock levels.',
      },
      {
        ...
        probability: 'Low',
        mitigation:
          'Comply with PCI DSS standards, use encryption for sensitive data, and conduct regular security audits and penetration testing.',
      },
    ],
    featureDependencies: {
    ...
    marketAnalysis:
      'The e-commerce market is highly competitive. Differentiation can be achieved through niche products, superior user experience, or building a strong brand community.',
  ...
  },
  {
    ...
    shortDescription:
      'A multi-tenant SaaS application with subscription billing and role-based access control.',
    businessGoals:
      'Acquire and retain business customers through a valuable and reliable service, based on a recurring revenue model.',
    technicalGoals:
      'Build a secure, scalable multi-tenant architecture. Implement a reliable subscription and billing system.',
    ...
    coreModules: [
      {
        ...
        description:
          'Handle multi-tenant user accounts, organization hierarchies, and team management.',
        flows: [
      ...
      },
      {
        ...
        description:
          'Manage subscription plans, billing cycles, payments, and plan upgrades/downgrades.',
        flows: [
      ...
      },
      {
        ...
        description:
          'The main functionality of the SaaS platform (e.g., project management, CRM, or other business tool).',
        flows: [
    ...
    coreRequirements: [
      {
        id: '1',
        description: 'User authentication with team/organization support',
        priority: 'High',
      },
      {
        id: '2',
        description: 'Subscription plans and billing integration (e.g., Chargebee, Stripe)',
        priority: 'High',
      },
      { id: '3', description: 'Role-Based Access Control (RBAC) within teams', priority: 'High' },
      {
        id: '4',
        description: 'A core feature specific to the SaaS product (e.g., project management, CRM)',
        priority: 'High',
      },
    ],
    techStack: {
    ...
    riskAssessment: [
      {
        ...
        probability: 'Low',
        mitigation:
          'Implement strict database row-level security, conduct regular tenant data isolation testing, and use encrypted tenant-specific keys.',
      },
      {
        ...
        probability: 'Medium',
        mitigation:
          'Implement robust billing logic with comprehensive testing, integrate with reliable payment processors, and provide clear billing transparency.',
      },
      {
        ...
        probability: 'Low',
        mitigation:
          'Deploy redundant architecture with automatic failover, implement circuit breakers, and conduct regular disaster recovery testing.',
      },
    ],
    featureDependencies: {
    ...
    marketAnalysis:
      'B2B SaaS is about solving a specific business problem more efficiently than existing solutions. Customer support and reliability are paramount. The sales cycle is longer, but customer lifetime value is higher.',
  ...
  },
  {
    ...
    shortDescription:
      'A scalable API service for serving a machine learning model for tasks like image recognition or NLP.',
    businessGoals:
      'Provide a reliable, high-performance API for developers to integrate AI capabilities into their applications.',
    technicalGoals:
      'Low-latency model inference, high throughput, robust API key management, and easy deployment.',
    ...
    coreModules: [
      ...
      },
      {
        ...
        description:
          'Manage authentication, rate limiting, request routing, and API documentation.',
        flows: [
    ...
    coreRequirements: [
      ...
      {
        id: '2',
        description: 'API key authentication and usage tracking/rate limiting',
        priority: 'High',
      },
      {
        id: '3',
        description: 'Infrastructure for model deployment and versioning',
        priority: 'Medium',
      },
    ...
    riskAssessment: [
      {
        ...
        probability: 'High',
        mitigation:
          'Implement continuous monitoring, automated retraining pipelines, and regular model validation against ground truth data.',
      },
      {
        ...
        probability: 'Medium',
        mitigation:
          'Deploy across multiple availability zones, implement automatic failover, and provide clear SLA guarantees.',
      },
      {
        ...
        probability: 'Low',
        mitigation:
          'Use secure model serving frameworks, implement input validation, sanitize outputs, and conduct regular security audits.',
      },
    ],
    featureDependencies: {
    ...
    marketAnalysis:
      'The AI API market is rapidly growing. Success hinges on the quality and uniqueness of the underlying model, as well as the reliability and ease of use of the API.',
  ...
  },
  {
    ...
    shortDescription:
      'Comprehensive educational management system for schools, covering students, staff, inventory, products, and events with detailed role-based flows.',
    businessGoals:
      'Centralize management for schools, reduce administrative overhead, and improve communication between departments and staff.',
    technicalGoals:
      'Implement a secure, modular, and scalable education management system with standardized workflows.',
    targetUsers: [
      'Giám đốc',
      'Hiệu trưởng',
      'Quản lý',
    ...
    coreModules: [
      {
        ...
        description:
          'Manage student data, enrollment, attendance, grades, tuition, and communication.',
        flows: [
      ...
      },
      {
        ...
        description:
          'Manage teacher and staff records, departments, attendance, salary, and performance.',
        flows: [
      ...
      },
      {
        ...
        description:
          'Track and manage school inventory, supplies, uniforms, and educational materials.',
        flows: [
      ...
      },
      {
        ...
        flows: ['Role Definition Flow', 'Permission Assignment Flow', 'Access Validation Flow'],
      },
    ],
    rolePermissions: [
      {
    ...
    coreRequirements: [
      {
        id: '1',
        description:
          'Student Information System (SIS) including enrollment, attendance, and grades',
        priority: 'High',
      },
      {
        id: '2',
        description: 'Staff Management for teacher/staff records, attendance, and salary',
        priority: 'High',
      },
      {
        id: '3',
        description: 'Inventory Management for school supplies and materials',
        priority: 'Medium',
      },
      {
        id: '4',
        description: 'Event Management for school activities and competitions',
        priority: 'Medium',
      },
      {
        id: '5',
        description: 'Product Management for internal sales of books and uniforms',
        priority: 'Low',
      },
    ],
    techStack: {
      frontend: ['Vue.js 3', 'Tailwind CSS', 'Vite'],
      backend: ['ASP.NET Core MVC', 'RESTful API', 'JWT Authentication'],
      database: ['SQL Server'],
      otherTools: ['Chart.js', 'Serilog', 'Swagger', 'Docker', 'GitHub Actions'],
    },
    riskAssessment: [
      {
        ...
        probability: 'Medium',
        mitigation:
          'Implement robust encryption, regular security audits, and compliance with data protection regulations like GDPR or local equivalents.',
      },
      {
        ...
        probability: 'Low',
        mitigation:
          'Deploy scalable infrastructure with load balancing, implement redundancy measures, and perform regular maintenance during off-peak hours.',
      },
      {
        ...
        probability: 'High',
        mitigation:
          'Conduct comprehensive training programs, provide ongoing support, and demonstrate clear benefits through phased implementation.',
      },
    ],
    featureDependencies: {
    ...
    marketAnalysis:
      'Educational institutions are rapidly digitizing. A unified platform like this can streamline academic and operational workflows, making it highly adaptable for schools, colleges, and training centers.',
    competitors: ['Schoology', 'MyClassCampus', 'EduAdmin', 'CampusCare'],
    meta: {
      category: 'education',
      size: 'large',
  ...
  },
  {
    ...
    shortDescription:
      'Comprehensive healthcare management platform for hospitals and clinics, managing patients, appointments, medical records, and billing.',
    businessGoals:
      'Improve patient care quality, streamline hospital operations, and ensure compliance with healthcare regulations.',
    technicalGoals:
      'Build a secure, HIPAA-compliant system with real-time data synchronization and robust reporting capabilities.',
    targetUsers: [
    ...
    coreRequirements: [
      {
        id: '1',
        description:
          'Patient Management with registration, medical records (EHR), and treatment plans',
        priority: 'High',
      },
      {
        id: '2',
        description: 'Appointment Scheduling for doctors, consultations, and procedures',
        priority: 'High',
      },
      {
        id: '3',
        description: 'Billing & Insurance module for claim processing and payments',
        priority: 'High',
      },
      {
        id: '4',
        description: 'Role-based access control for all user types (HIPAA compliance)',
        priority: 'High',
      },
    ],
    techStack: {
      ...
      otherTools: ['Docker', 'Nginx', 'ELK Stack', 'JWT', 'Stripe for payments'],
    },
    riskAssessment: [
      {
        ...
        probability: 'Medium',
        mitigation:
          'Implement HIPAA-compliant encryption, regular audits, and strict access controls with audit logging.',
      },
      {
        ...
        probability: 'Low',
        mitigation:
          'Deploy redundant systems, conduct regular failover testing, and have manual backup procedures.',
      },
      {
        ...
        probability: 'High',
        mitigation:
          'Conduct thorough requirements gathering, perform integration testing, and provide comprehensive documentation.',
      },
    ],
    featureDependencies: {
    ...
    marketAnalysis:
      'Healthcare digitization is accelerating due to regulatory requirements and the need for better patient outcomes. Systems must prioritize security, interoperability, and user-friendly interfaces for medical professionals.',
    competitors: ['Epic Systems', 'Cerner', 'Meditech', 'Allscripts'],
    meta: {
      category: 'healthcare',
      size: 'large',
  ...
  },
  {
    ...
    shortDescription:
      'Complete real estate management solution for property owners, agents, and tenants with listing management, tenant screening, and maintenance tracking.',
    businessGoals:
      'Streamline property management operations, improve tenant satisfaction, and maximize rental income for property owners.',
    technicalGoals:
      'Create a user-friendly platform with automated workflows, secure document storage, and comprehensive reporting features.',
    targetUsers: [
      'Property Owners',
      'Real Estate Agents',
      'Property Managers',
    ...
    coreModules: [
      ...
      },
      {
        ...
        description:
          'Track maintenance requests, schedule repairs, and manage vendor relationships.',
        flows: [
    ...
    techStack: {
      ...
      database: ['PostgreSQL'],
      otherTools: ['AWS S3', 'Stripe', 'SendGrid', 'Docker', 'Redis'],
    },
    riskAssessment: [
      {
        ...
        probability: 'Medium',
        mitigation:
          'Implement comprehensive data encryption, GDPR/CCPA compliance measures, and regular privacy audits.',
      },
      {
        ...
        probability: 'High',
        mitigation:
          'Establish vendor contracts with SLAs, maintain emergency service backups, and implement budget tracking controls.',
      },
      {
        ...
        probability: 'High',
        mitigation:
          'Implement automated marketing tools, comprehensive property search features, and predictive analytics for vacancy forecasting.',
      },
    ],
    featureDependencies: {
    ...
    marketAnalysis:
      'Property management is becoming increasingly digital. Modern tenants expect online portals, digital payments, and quick response times. The market favors platforms that can handle multiple property types and scales.',
